package com.formations.graphqltp.service.impl;

import com.formations.graphqltp.service.interfaces.ITransactionService;
import lombok.AllArgsConstructor;
import com.formations.graphqltp.dao.BankAccountRepository;
import com.formations.graphqltp.dao.BankAccountTransactionRepository;
import com.formations.graphqltp.dao.UserRepository;
...
import com.formations.graphqltp.enums.TransactionType;
...
import com.formations.graphqltp.model.GetTransactionListBo;
import com.formations.graphqltp.model.User;
...
public class TransactionServiceImpl implements ITransactionService {
    ...
    public AddWirerTransferResponse wiredTransfer(AddWirerTransferRequest dto) {
        ...
        BankAccount bankAccountFrom = bankAccountRepository.findByRib(ribFrom).orElseThrow(() -> new BusinessException(String.format("No bank account have the rib %s", ribFrom)));
