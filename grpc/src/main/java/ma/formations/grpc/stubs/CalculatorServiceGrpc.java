...
public final class CalculatorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.formations.grpc.stubs.Calculator.ClientStreamRequest,
      ma.formations.grpc.stubs.Calculator.ClientStreamResponse> getPerformStreamnMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "performStreamn",
  ...
  public static io.grpc.MethodDescriptor<ma.formations.grpc.stubs.Calculator.ClientStreamRequest,
      ma.formations.grpc.stubs.Calculator.ClientStreamResponse> getPerformStreamnMethod() {
    io.grpc.MethodDescriptor<ma.formations.grpc.stubs.Calculator.ClientStreamRequest, ma.formations.grpc.stubs.Calculator.ClientStreamResponse> getPerformStreamnMethod;
    if ((getPerformStreamnMethod = CalculatorServiceGrpc.getPerformStreamnMethod) == null) {
      synchronized (CalculatorServiceGrpc.class) {
        if ((getPerformStreamnMethod = CalculatorServiceGrpc.getPerformStreamnMethod) == null) {
          CalculatorServiceGrpc.getPerformStreamnMethod = getPerformStreamnMethod = 
              ...
              .setFullMethodName(generateFullMethodName(
                  "CalculatorService", "performStreamn"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new CalculatorServiceMethodDescriptorSupplier("performStreamn"))
                  .build();
          }
        }
     }
     return getPerformStreamnMethod;
  }
  ...
  public static abstract class CalculatorServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ma.formations.grpc.stubs.Calculator.ClientStreamRequest> performStreamn(
        io.grpc.stub.StreamObserver<ma.formations.grpc.stubs.Calculator.ClientStreamResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getPerformStreamnMethod(), responseObserver);
    }
  ...
  public static final class CalculatorServiceStub extends io.grpc.stub.AbstractStub<CalculatorServiceStub> {
    ...
    public io.grpc.stub.StreamObserver<ma.formations.grpc.stubs.Calculator.ClientStreamRequest> performStreamn(
      ...
      return asyncClientStreamingCall(
          getChannel().newCall(getPerformStreamnMethod(), getCallOptions()), responseObserver);
    }
  ...
  private static final int METHODID_PERFORM_STREAMN = 2;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_PERFORM_STREAMN:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.performStreamn(
              (io.grpc.stub.StreamObserver<ma.formations.grpc.stubs.Calculator.ClientStreamResponse>) responseObserver);
      ...
      synchronized (CalculatorServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getPerformStreamnMethod())
